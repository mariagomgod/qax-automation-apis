...
En esta misión vamos a explorar la api de **The Simpsons** ([The Simpsons Docs](https://thesimpsonsapi.com/#docs)), una API pública que proporciona información sobre los personajes, episodios y locaciones de la serie animada `The Simpsons`.

El objetivo es aprender a transformar una historia de usuario y sus criterios de aceptación en **casos de prueba claros**, ejecutarlos primero manualmente en **Postman** y luego automatizarlos usando **Rest Assured**.
