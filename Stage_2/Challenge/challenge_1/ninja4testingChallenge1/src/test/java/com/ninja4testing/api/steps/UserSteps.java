...
import static com.ninja4testing.api.utils.DataFactory.generarPassword;
import static com.ninja4testing.api.utils.DataFactory.generarUsername;
...
public class UserSteps {
    ...
    public void usuarioConCredencialesValidas() {
        if (!RunContext.hasCreds()) {
            userName = DataFactory.generarUsername();
            password = DataFactory.generarPassword();
            RunContext.setCreds(userName, password);
        } else {
